 ...
 * a class and add a method. Create a static method that downcasts a reference
 * from the base class to the derived class and calls the method. Demonstrate
 * that it works in main(). Eliminate the need for the downcast by moving the
 * abstract declaration to the base class.
 ***********************************************/
